...
const settingGroups = computed(() => {
  ...
  const groups = [
    ...
    },
    {
      ...
      ids: ['AndreaNovelHelper.packageManager.enableAutoKeywordNaming', 'AndreaNovelHelper.packageManager.hideOutlineStorage', 'AndreaNovelHelper.packageManager.hideCommentsFolder', 'AndreaNovelHelper.packageManager.hideTypoFolder', 'AndreaNovelHelper.packageManager.hideDashboardFolder', 'AndreaNovelHelper.packageManager.hideDocsFolder', 'AndreaNovelHelper.packageManager.showGeneralResourceFiles', 'AndreaNovelHelper.packageManager.showRoleFileChangeNotifications', 'AndreaNovelHelper.package.dragDefaultAction', 'AndreaNovelHelper.package.iconStyle', 'AndreaNovelHelper.package.roleNodes.display.useRoleSvgIfPresent', 'AndreaNovelHelper.package.roleNodes.display.colorizeRoleName', 'AndreaNovelHelper.package.roleNodes.details.showColorOnValue', 'AndreaNovelHelper.package.roleNodes.details.alwaysExpandable', 'AndreaNovelHelper.package.roleNodes.details.enableRoleExpansion', 'AndreaNovelHelper.package.roleNodes.details.enableWrapping', 'AndreaNovelHelper.package.roleNodes.details.wrapColumn']
    },
    {
      id: 'typoSystem',
      name: '错别字检查',
