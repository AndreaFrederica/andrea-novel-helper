# Andrea Novel Helper 功能列表

本文档基于 `README.md` 和 `CHANGELOG.md` 整理，汇总了 Andrea Novel Helper (小说助手) 的核心功能与特性。
...
- **智能格式化**：
  - **智慧回车**：智能处理段落换行。
  - **智慧括号**：成对符号自动补全与跳出。
  - **自动空行**：命令 `andrea.formatDocument.addBlanks` 自动补充段间空行。
  - **版式设置**：自定义段首/段尾标点规则。
- **错别字检测**：内置错别字统计与识别功能。
...
---
*文档生成于：2025-11-20 (基于 v0.4.33 版本)*
