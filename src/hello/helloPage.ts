...
const HELLO_I18N_ZH_CN: Record<string, string> = {
    ...
    writingExplorer: '打开写作资源管理器',
    writingExplorerDesc: '浏览和管理小说项目的章节文件、大纲和资料文件。',
    dashboard: '打开创作工作台',
    ...
    batchExport: '批量导出',
    batchExportDesc: '选择章节文件，批量导出为 PDF、图片或纯文本。',
    docCenter: '文档中心',
    docCenterDesc: '浏览完整的功能文档、格式指南和操作教程。',
...
const HELLO_I18N_EN: Record<string, string> = {
    ...
    batchExportDesc: 'Select chapter files and batch export as PDF, images, or plain text.',
