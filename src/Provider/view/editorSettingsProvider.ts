...
export class EditorSettingsWebviewProvider implements vscode.WebviewViewProvider {
    ...
    private isQuickSetting(key: string): boolean {
        ...
        const quickSettingKeys = [
            ...
            'AndreaNovelHelper.packageManager.enableAutoKeywordNaming',
            'AndreaNovelHelper.packageManager.hideOutlineStorage',
            'AndreaNovelHelper.packageManager.hideCommentsFolder',
            'AndreaNovelHelper.packageManager.hideTypoFolder',
            'AndreaNovelHelper.packageManager.hideDashboardFolder',
            'AndreaNovelHelper.packageManager.hideDocsFolder',
            'AndreaNovelHelper.packageManager.showGeneralResourceFiles',
            'AndreaNovelHelper.packageManager.showRoleFileChangeNotifications',
