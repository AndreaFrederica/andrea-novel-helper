---
name: anh-script-runtime
description: >-
  Domain knowledge for working with the ANH (Andrea Novel Helper) Script Runtime.
  Teaches agents how to read, write, and run scripts in the ANH script runner sidebar,
  including the runtime context API, MCP client integration, and mcp.json configuration.
user-invocable: true
---
