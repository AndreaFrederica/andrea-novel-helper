---
name: anh-typst-templates
description: >-
  Domain knowledge for working with the ANH (Andrea Novel Helper) Typst template system.
  Teaches agents how to read, write, and create Typst export templates — including
  template.json metadata, Liquid rendering, the Markdown block model, custom filters,
  and the VS Code preview integration.
user-invocable: true
---
